...
<body>
	...
	<h1>WELCOME TO BIB4YOU <i class="fa fa-book" aria-hidden="true"></i></h1>
	...
	<div class="container">
		...
		<div class="login">
			...
			<form action="index.php" method="post">
				<input type="text" Name="RollNo" placeholder="MLE" required="">
		...
		<div class="register">
			...
			<form action="index.php" method="post">
				...
				<select name="Category" id="Category">
					...
					<option value="Eleve Officier du rang">Eleve Officier du rang</option>
				</select>
				<br>
