            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">BIB4YOU <i class="menu-icon icon-book"></i> </a>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2025 BIB4YOU </b>All rights reserved.
            </div>
        </div>
